...
public class Rope : MonoBehaviour
{
    ...
    {
        //TODO: найти метод массива который удалит все элементы
        // очищаем сегменты веревки
    ...
    void CreateRopeSegment()
    {
        ...
        {
            // Эта проверка для фиксации ошибки при первой итерации когда нет
            // connectedObject(Prototype Leg Rope (UnityEngine.Rigidbody2D))
